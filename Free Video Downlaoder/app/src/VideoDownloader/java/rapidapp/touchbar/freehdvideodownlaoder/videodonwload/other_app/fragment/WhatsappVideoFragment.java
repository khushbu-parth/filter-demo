...
public class WhatsappVideoFragment extends Fragment {
    ...
    public void lambda$initViews$0$WhatsappVideoFragment() {
        this.statusModelArrayList = new ArrayList<>();
        getData();
    ...
    private void getData() {
        ...
        try {
            Arrays.sort(this.allfiles, $$Lambda$WhatsappVideoFragment$yPsMGIV3YsWPiSx29BLzgDEGEsY.INSTANCE);
        ...
        try {
            Arrays.sort(listFiles, $$Lambda$WhatsappVideoFragment$uiJOHyFu6G1Q71jYYuVx2uYH4T4.INSTANCE);
