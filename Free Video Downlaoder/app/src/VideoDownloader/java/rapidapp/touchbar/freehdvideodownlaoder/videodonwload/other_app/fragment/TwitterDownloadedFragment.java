...
public class TwitterDownloadedFragment extends Fragment implements FileListClickInterface {
    ...
    public static TwitterDownloadedFragment newInstance(String str) {
        TwitterDownloadedFragment twitterDownloadedFragment = new TwitterDownloadedFragment();
        Bundle bundle = new Bundle();
        bundle.putString("m", str);
        twitterDownloadedFragment.setArguments(bundle);
        return twitterDownloadedFragment;
    }
    ...
    private void initViews() {
        this.binding.swiperefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public final void onRefresh() {
                TwitterDownloadedFragment.this.lambda$initViews$0$TwitterDownloadedFragment();
            }
        });
    }

    public void lambda$initViews$0$TwitterDownloadedFragment() {
        getAllFiles();
