...
public class Ad_MoreAppListAdapter extends RecyclerView.Adapter<Ad_MoreAppListAdapter.ViewHolder> {
    ...
    public Ad_MoreAppListAdapter(Context context, ArrayList<MoreAppModel> moreAppData) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = layoutInflater.inflate(R.layout.ad_more_list_item, parent, false);
...
//                    if (getAdapterPosition() < appLists.size()) {
