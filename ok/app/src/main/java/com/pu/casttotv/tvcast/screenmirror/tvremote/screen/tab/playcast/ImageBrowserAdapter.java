...
public class ImageBrowserAdapter extends RecyclerView.Adapter<ImageBrowserAdapter.ChannelHolder> {
    ...
    public class ChannelHolder extends RecyclerView.ViewHolder {
        ...
        public void binData(downloadable_resource_model downloadable_resource_modelVar, final int i) {
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.magicapps.casttotv.tv.screen.tab.playcast.ImageBrowserAdapter.ChannelHolder.1
    ...
    public void setSelectedPosition(int i) {
        for (downloadable_resource_model downloadable_resource_modelVar : this.objectList) {
            downloadable_resource_modelVar.isSelected = false;
        }
