...
public class DragAudioAdapter extends DragAdapter {
    ...
    private final class Holder extends DragHolder {
        ...
        public void binData(final AudioModel audioModel, final int i) {
            Glide.with(DragAudioAdapter.this.mContext).load(Integer.valueOf((int) R.drawable.ic_icon_audio_song)).into(this.img_video_offline);
            ...
            this.imv_close.setOnClickListener(new View.OnClickListener() { // from class: com.magicapps.casttotv.tv.screen.tab.playcast.DragAudioAdapter.Holder.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    DragAudioAdapter.this.mListener.onDeleteItem(audioModel, i);
                }
            });
            this.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.magicapps.casttotv.tv.screen.tab.playcast.DragAudioAdapter.Holder.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
