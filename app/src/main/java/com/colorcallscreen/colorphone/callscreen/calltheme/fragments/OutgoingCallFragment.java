...
public class OutgoingCallFragment extends Fragment implements CallLogsAdapter.OnRefreshListener, HistoryFragment.HistoryUpdateListener, CallLogsView {
    private Thread filterListThread;
    private long fromDate;
    AppCompatImageView ivClose;
    AppCompatImageView ivSearch;
    CallLogComponent logComponent;
    private CallLogsAdapter outgoingCallAdapter;
    TextView permission_txt;
    private RecyclerView rVCallLog;
    private long toDate;
    AppCompatTextView tvNoFound;
    public AppCompatEditText tvSearch;
    List<CallLogModel> outgoingCallList = new ArrayList();
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        appCompatEditText.addTextChangedListener(new TextWatcher() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.OutgoingCallFragment.1
            ...
            public void afterTextChanged(Editable editable) {
                if (editable.length() <= 0) {
                    OutgoingCallFragment.this.queryStr = "";
                    OutgoingCallFragment.this.outgoingCallAdapter.hasSearch = false;
                    OutgoingCallFragment.this.outgoingCallAdapter.query = null;
                    OutgoingCallFragment outgoingCallFragment = OutgoingCallFragment.this;
                    outgoingCallFragment.searchContactsForQuery(outgoingCallFragment.queryStr, OutgoingCallFragment.this.outgoingCallList);
                    OutgoingCallFragment.this.ivClose.setVisibility(8);
                    Utility.hideSoftKeyboard(OutgoingCallFragment.this.requireActivity());
                    OutgoingCallFragment.this.tvSearch.clearFocus();
                    return;
                }
                OutgoingCallFragment.this.queryStr = editable.toString();
                if (OutgoingCallFragment.this.outgoingCallAdapter != null) {
                    OutgoingCallFragment.this.outgoingCallAdapter.query = OutgoingCallFragment.this.queryStr;
                    OutgoingCallFragment.this.outgoingCallAdapter.hasSearch = true;
                    OutgoingCallFragment outgoingCallFragment2 = OutgoingCallFragment.this;
                    outgoingCallFragment2.searchContactsForQuery(outgoingCallFragment2.queryStr, OutgoingCallFragment.this.outgoingCallList);
                }
                OutgoingCallFragment.this.ivClose.setVisibility(0);
            }
        });
        this.ivClose.setOnClickListener(new View.OnClickListener() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.OutgoingCallFragment.2
            @Override 
            public void onClick(View view2) {
                OutgoingCallFragment.this.onClearSearchView();
            }
        });
        ...
        this.rVCallLog.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.OutgoingCallFragment.3
            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                super.onScrollStateChanged(recyclerView, i);
                if (OutgoingCallFragment.this.getActivity() != null && ((InputMethodManager) OutgoingCallFragment.this.getActivity().getSystemService("input_method")).isActive()) {
                    Utility.hideSoftKeyboard(OutgoingCallFragment.this.getActivity());
                }
            }
        });
        ...
        if (ContextCompat.checkSelfPermission(getContext(), BoloPermission.READ_CALL_LOG) != 0 || ContextCompat.checkSelfPermission(getContext(), BoloPermission.WRITE_CALL_LOG) != 0 || ContextCompat.checkSelfPermission(getActivity(), BoloPermission.PHONE_CALLS) != 0) {
            ...
            this.logComponent.loadCallLogs(null, -1L, -1L, false, 0, 2);
        }
    }
    ...
    public void notifyForDataSetChange() {
        new Handler().postDelayed(new Runnable() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.OutgoingCallFragment.4
            @Override 
            public void run() {
                if (OutgoingCallFragment.this.outgoingCallAdapter == null) {
                    return;
                }
                if (OutgoingCallFragment.this.outgoingCallList.size() > 0) {
                    OutgoingCallFragment outgoingCallFragment = OutgoingCallFragment.this;
                    boolean z = false;
                    outgoingCallFragment.fromDate = Long.parseLong(outgoingCallFragment.outgoingCallList.get(0).getDate()) + 1;
                    OutgoingCallFragment.this.toDate = CallLogUtils.getCurrentDate();
                    List<CallLogModel> queryForCallLogs = OutgoingCallFragment.this.logComponent.queryForCallLogs(null, OutgoingCallFragment.this.fromDate, OutgoingCallFragment.this.toDate, true, -1, 2);
                    if (queryForCallLogs != null && !queryForCallLogs.isEmpty()) {
                        ...
                        if (it.hasNext()) {
                            ...
                            if (callLogModel.getCallType() == 2) {
                                if (OutgoingCallFragment.this.outgoingCallList.size() > 0 && callLogModel.getNumber() != null) {
                                    CallLogModel callLogModel2 = OutgoingCallFragment.this.outgoingCallList.get(0);
                                    if (callLogModel2.getNumber().equals(callLogModel.getNumber())) {
                                        ...
                                        OutgoingCallFragment.this.outgoingCallList.set(0, callLogModel2);
                                    } else {
                                        OutgoingCallFragment.this.outgoingCallList.add(0, callLogModel);
                                    }
                                } else {
                                    OutgoingCallFragment.this.outgoingCallList.add(0, callLogModel);
                                }
                    ...
                    if (OutgoingCallFragment.this.outgoingCallAdapter == null || !z) {
                        return;
                    }
                    OutgoingCallFragment.this.outgoingCallAdapter.setCallLogModel(OutgoingCallFragment.this.outgoingCallList);
                    OutgoingCallFragment.this.rVCallLog.stopScroll();
                    return;
                }
                OutgoingCallFragment.this.logComponent.loadCallLogs(null, -1L, -1L, false, 0, 2);
            }
        }, 500L);
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (BoloPermission.DEVICE_SETTING_REQ == i) {
            ...
            this.logComponent.loadCallLogs(null, this.fromDate, this.toDate, false, -1, 2);
            this.permission_txt.setVisibility(8);
        } else if (i == 1003 && i2 == -1) {
            String stringExtra = intent.getStringExtra("phoneNumber");
            for (CallLogModel callLogModel : this.outgoingCallList) {
                if (callLogModel.getNumber().equals(stringExtra)) {
                    this.outgoingCallList.remove(callLogModel);
                    this.outgoingCallAdapter.setCallLogModel(this.outgoingCallList);
                    return;
                }
            }
        }
    ...
    public void onCallLogLoaded(List<CallLogModel> list) {
        if (list == null) {
            ...
            this.outgoingCallList.addAll(list);
        }
        CallLogsAdapter callLogsAdapter = new CallLogsAdapter(requireActivity(), this.outgoingCallList, R.layout.item_call_logs, this);
        this.outgoingCallAdapter = callLogsAdapter;
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (ContextCompat.checkSelfPermission(context, BoloPermission.READ_CALL_LOG) != 0 && ContextCompat.checkSelfPermission(context, BoloPermission.WRITE_CALL_LOG) != 0 && ContextCompat.checkSelfPermission(context, BoloPermission.PHONE_CALLS) != 0) {
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                this.permission_txt.setOnClickListener(new View.OnClickListener() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.OutgoingCallFragment.5
                    @Override 
                    public void onClick(View view) {
                        BoloPermission.openApplicationSetting(OutgoingCallFragment.this);
                    }
                });
                return;
            }
    ...
    public void onRefresh() {
        if (this.outgoingCallList.size() > 0) {
    ...
    public void searchContactsForQuery(String str, final List<CallLogModel> list) {
        ...
        if (!lowerCase.isEmpty() && !list.isEmpty()) {
            ...
            Thread thread2 = new Thread(new Runnable() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.OutgoingCallFragment.6
                @Override 
                public void run() {
                    for (CallLogModel callLogModel : list) {
                        if (OutgoingCallFragment.this.filterListThread == null || OutgoingCallFragment.this.filterListThread.isInterrupted()) {
                            return;
                        }
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.OutgoingCallFragment.6.1
                        @Override 
                        public void run() {
                            OutgoingCallFragment.this.filterListThread = null;
                            if (arrayList3.isEmpty() && lowerCase.isEmpty()) {
                                arrayList3.addAll(list);
                            }
                            OutgoingCallFragment.this.onFilterCompleted(arrayList3);
                        }
                    });
                }
            });
    ...
    public void onFilterCompleted(List<CallLogModel> list) {
        ...
        CallLogsAdapter callLogsAdapter = this.outgoingCallAdapter;
        if (callLogsAdapter == null) {
            ...
            this.outgoingCallAdapter = callLogsAdapter2;
