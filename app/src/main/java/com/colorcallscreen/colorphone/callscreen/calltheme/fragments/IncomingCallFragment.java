...
public class IncomingCallFragment extends Fragment implements CallLogsAdapter.OnRefreshListener, HistoryFragment.HistoryUpdateListener, CallLogsView {
    private Thread filterListThread;
    private long fromDate;
    private CallLogsAdapter incomingCallAdapter;
    ...
    List<CallLogModel> incomingCallList = new ArrayList();
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        appCompatEditText.addTextChangedListener(new TextWatcher() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.IncomingCallFragment.1
            ...
            public void afterTextChanged(Editable editable) {
                if (editable.length() <= 0) {
                    IncomingCallFragment.this.queryStr = "";
                    IncomingCallFragment.this.incomingCallAdapter.hasSearch = false;
                    IncomingCallFragment.this.incomingCallAdapter.query = null;
                    IncomingCallFragment incomingCallFragment = IncomingCallFragment.this;
                    incomingCallFragment.searchContactsForQuery(incomingCallFragment.queryStr, IncomingCallFragment.this.incomingCallList);
                    IncomingCallFragment.this.ivClose.setVisibility(8);
                    Utility.hideSoftKeyboard(IncomingCallFragment.this.requireActivity());
                    IncomingCallFragment.this.tvSearch.clearFocus();
                    return;
                }
                IncomingCallFragment.this.queryStr = editable.toString();
                Log.println(7, "log===", IncomingCallFragment.this.queryStr);
                if (IncomingCallFragment.this.incomingCallAdapter != null) {
                    IncomingCallFragment.this.incomingCallAdapter.query = IncomingCallFragment.this.queryStr;
                    IncomingCallFragment.this.incomingCallAdapter.hasSearch = true;
                    IncomingCallFragment incomingCallFragment2 = IncomingCallFragment.this;
                    incomingCallFragment2.searchContactsForQuery(incomingCallFragment2.queryStr, IncomingCallFragment.this.incomingCallList);
                }
                IncomingCallFragment.this.ivClose.setVisibility(0);
            }
        });
        this.ivClose.setOnClickListener(new View.OnClickListener() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.IncomingCallFragment.2
            @Override 
            public void onClick(View view2) {
                IncomingCallFragment.this.onClearSearchView();
            }
        });
        ...
        this.rVCallLog.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.IncomingCallFragment.3
            @Override // androidx.recyclerview.widget.RecyclerView.OnScrollListener
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                super.onScrollStateChanged(recyclerView, i);
                if (IncomingCallFragment.this.getActivity() != null && ((InputMethodManager) IncomingCallFragment.this.getActivity().getSystemService("input_method")).isActive()) {
                    Utility.hideSoftKeyboard(IncomingCallFragment.this.getActivity());
                }
            }
        });
        ...
        if (ContextCompat.checkSelfPermission(getContext(), BoloPermission.READ_CALL_LOG) != 0 || ContextCompat.checkSelfPermission(getContext(), BoloPermission.WRITE_CALL_LOG) != 0 || ContextCompat.checkSelfPermission(getActivity(), BoloPermission.PHONE_CALLS) != 0) {
            ...
            this.logComponent.loadCallLogs(null, -1L, -1L, false, 0, 1);
        }
    }
    ...
    public void notifyForDataSetChange() {
        new Handler().postDelayed(new Runnable() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.IncomingCallFragment.4
            @Override 
            public void run() {
                if (IncomingCallFragment.this.incomingCallAdapter == null) {
                    return;
                }
                if (IncomingCallFragment.this.incomingCallList.size() > 0) {
                    IncomingCallFragment incomingCallFragment = IncomingCallFragment.this;
                    boolean z = false;
                    incomingCallFragment.fromDate = Long.parseLong(incomingCallFragment.incomingCallList.get(0).getDate()) + 1;
                    IncomingCallFragment.this.toDate = CallLogUtils.getCurrentDate();
                    List<CallLogModel> queryForCallLogs = IncomingCallFragment.this.logComponent.queryForCallLogs(null, IncomingCallFragment.this.fromDate, IncomingCallFragment.this.toDate, true, -1, 1);
                    if (queryForCallLogs != null && !queryForCallLogs.isEmpty()) {
                        ...
                        if (it.hasNext()) {
                            ...
                            if (callLogModel.getCallType() == 1) {
                                if (IncomingCallFragment.this.incomingCallList.size() > 0 && callLogModel.getNumber() != null) {
                                    CallLogModel callLogModel2 = IncomingCallFragment.this.incomingCallList.get(0);
                                    if (callLogModel2.getNumber().equals(callLogModel.getNumber())) {
                                        ...
                                        IncomingCallFragment.this.incomingCallList.set(0, callLogModel2);
                                    } else {
                                        IncomingCallFragment.this.incomingCallList.add(0, callLogModel);
                                    }
                                } else {
                                    IncomingCallFragment.this.incomingCallList.add(0, callLogModel);
                                }
                    ...
                    if (IncomingCallFragment.this.incomingCallAdapter == null || !z) {
                        return;
                    }
                    IncomingCallFragment.this.incomingCallAdapter.setCallLogModel(IncomingCallFragment.this.incomingCallList);
                    IncomingCallFragment.this.rVCallLog.stopScroll();
                    return;
                }
                IncomingCallFragment.this.logComponent.loadCallLogs(null, -1L, -1L, false, 0, 1);
            }
        }, 500L);
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (BoloPermission.DEVICE_SETTING_REQ == i) {
            ...
            this.logComponent.loadCallLogs(null, this.fromDate, this.toDate, false, -1, 1);
            this.permission_txt.setVisibility(8);
        } else if (i == 1003 && i2 == -1) {
            String stringExtra = intent.getStringExtra("phoneNumber");
            for (CallLogModel callLogModel : this.incomingCallList) {
                if (callLogModel.getNumber().equals(stringExtra)) {
                    this.incomingCallList.remove(callLogModel);
                    this.incomingCallAdapter.setCallLogModel(this.incomingCallList);
                    return;
                }
            }
        }
    ...
    public void onCallLogLoaded(List<CallLogModel> list) {
        if (list == null) {
            ...
            this.incomingCallList.addAll(list);
        }
        CallLogsAdapter callLogsAdapter = new CallLogsAdapter(requireActivity(), this.incomingCallList, R.layout.item_call_logs, this);
        this.incomingCallAdapter = callLogsAdapter;
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (ContextCompat.checkSelfPermission(context, BoloPermission.READ_CALL_LOG) != 0 && ContextCompat.checkSelfPermission(context, BoloPermission.WRITE_CALL_LOG) != 0 && ContextCompat.checkSelfPermission(context, BoloPermission.PHONE_CALLS) != 0) {
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                this.permission_txt.setOnClickListener(new View.OnClickListener() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.IncomingCallFragment.5
                    @Override 
                    public void onClick(View view) {
                        BoloPermission.openApplicationSetting(IncomingCallFragment.this);
                    }
                });
                return;
            }
    ...
    public void onRefresh() {
        if (this.incomingCallList.size() > 0) {
    ...
    public void searchContactsForQuery(String str, final List<CallLogModel> list) {
        ...
        if (!lowerCase.isEmpty() && !list.isEmpty()) {
            ...
            Thread thread2 = new Thread(new Runnable() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.IncomingCallFragment.6
                @Override 
                public void run() {
                    for (CallLogModel callLogModel : list) {
                        if (IncomingCallFragment.this.filterListThread == null || IncomingCallFragment.this.filterListThread.isInterrupted()) {
                            return;
                        }
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.colorcallscreen.colorphone.callscreen.calltheme.fragments.IncomingCallFragment.6.1
                        @Override 
                        public void run() {
                            IncomingCallFragment.this.filterListThread = null;
                            if (arrayList3.isEmpty() && lowerCase.isEmpty()) {
                                arrayList3.addAll(list);
                            }
                            IncomingCallFragment.this.onFilterCompleted(arrayList3);
                        }
                    });
                }
            });
    ...
    public void onFilterCompleted(List<CallLogModel> list) {
        ...
        CallLogsAdapter callLogsAdapter = this.incomingCallAdapter;
        if (callLogsAdapter == null) {
            ...
            this.incomingCallAdapter = callLogsAdapter2;
